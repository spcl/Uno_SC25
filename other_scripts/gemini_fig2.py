...
for ecn_value in ecn_absolute_values:
    ...
    cmd = (
        ...
        f"-mdRTT 0.0003515625 -interdcDelay 4865000 -forceQueueSize {queue_Size * 1} -end_time 80000 -mtu 1500 -dctcp -forceKmin {ecn_value * mtu_size} -forceKmax {ecn_value * mtu_size} -forceCWND 15000 > tmp.tmp"
    )
    print(f"Running: {cmd}")
