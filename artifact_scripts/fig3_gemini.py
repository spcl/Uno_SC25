...
def plot_gemini_rate():
    ...
    data_folder = os.path.join("phantomQ", "4_4_1000MB_gemini/output/sending_rate")
    ...
    for txt in txt_files:
        try:
            ...
            match = re.search(r"rategemini_(\d+)_", label)
            if match:
    ...
    plt.tight_layout()
    plt.ylim(0,100)
    plt.savefig("artifact_results/fig3/gemini_rate_plot.png", dpi=300)
    plt.savefig("artifact_results/fig3/gemini_rate_plot.pdf", dpi=300)
    #plt.show()
