...
def plot_results(bench_results):
    ...
    if not os.path.exists(results_folder):
        os.makedirs(results_folder)
    plt.savefig("artifact_results/fig12/link_failure_violin.png", bbox_inches="tight")
    plt.savefig("artifact_results/fig12/link_failure_violin.pdf", bbox_inches="tight")
    #plt.show()
