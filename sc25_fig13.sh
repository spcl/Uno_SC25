...
python3 lcp/scripts/plot_script_micro.py --input_folder exp_data/incast_experiment_fat_tree_100Gbps/tm=websearchIntra_AlibabaInter_5000f_40l-lb=ecmp_classic-os_b=16-noFi-noQaInter-noQaIntra-queueSizeRatio=0.1-kmin=25-kmax=75-alpha=0.5-pace-K=6-interAlgo=gemini-intraAlgo=gemini-geminiH=0.00024-geminiBeta=0.1-geminiT=5-delay=886500/output/ --fct_only > ./fig13_results/gemini_40.txt
...
python3 lcp/scripts/plot_script_micro.py --input_folder exp_data/incast_experiment_fat_tree_100Gbps/tm=websearchIntra_AlibabaInter_5000f_40l-lb=ecmp_classic-os_b=16-noFi-noQaInter-noQaIntra-noRto-queueSizeRatio=0.1-wanKmin=25-wanKmin=75-kmin=25-kmax=75-alpha=0.5-pace-K=6-interAlgo=bbr-ccAlgoIntra=mprdma-delay=886500/output/ --fct_only > ./fig13_results/bbr_mprdma_40.txt
