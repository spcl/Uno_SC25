...
def main(args):
    ...
    fig = make_subplots(rows=9, cols=1, specs=[[{}], [{}], [{}], [{}], [{}], [{}], [{}], [{}], [{}]], shared_xaxes=False, vertical_spacing=0.1, subplot_titles=(f"min FCT: {min_fct}us, average FCT: {mean_fct}us, max FCT: {max_fct}us, JCT: {job_completion_time}us", "Rate", "RTT", 'Inter-DC Queue occupancy', 'Intra-DC Queue occupancy', "queue overflow", 'Bytes acked', 'Inflight bytes', f'Sent packets(retrans: {total_retrans_count})'))
