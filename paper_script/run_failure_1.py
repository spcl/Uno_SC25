...
def plot_results(bench_results):
    ...
    # to a tuple: (avg_fct, p99_fct). Now including 5 algorithms.
    algo_keys = ["uno", "UnoLB", "UnoEC", "gemini", "bbr"]
    algo_names = ["Uno+ECMP", "Uno", "Uno+EC", "Gemini", "MPRDMA+BBR"]
    ...
    plt.tight_layout()
    plt.savefig("permutation_fct2.png", dpi=300)
    plt.savefig("permutation_fct2.pdf", dpi=300)
    plt.show()
