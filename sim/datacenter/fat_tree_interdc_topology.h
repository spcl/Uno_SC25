...
class FatTreeInterDCTopology : public Topology {
  public:
    ...
    BaseQueue *alloc_queue_no_ecn(QueueLogger *q, uint64_t speed, mem_b queuesize, link_direction dir, int switch_tier,
                           bool tor, double random_drop_perc=-1);
    BaseQueue *alloc_queue_inter(QueueLogger *q, uint64_t speed, mem_b queuesize, link_direction dir, int switch_tier,
                           bool tor, double random_drop_perc=-1);
    ...
    static void set_interdc_ecn_thresholds_as_queue_percentage(bool use_interdc_ecn, 
                                                        int min_thresh=-1,
                                                       int max_thresh=-1) {
        use_inter_dc_ecn = use_interdc_ecn;
        inter_dc_kmin = min_thresh;
        inter_dc_kmax = max_thresh;
    }
    ...
    static void set_random_drop_perc(double value) { random_drop_perc = value; }
    ...
    static double _percentage_link_down;
    static bool _fail_one;  
  ...
  private:
    ...
    simtime_picosec _link_latency, _switch_latency;
    static int kmin;
    static int kmax;
    ...
    static int inter_dc_kmin;
    static int inter_dc_kmax;
    static bool use_inter_dc_ecn;
    static double random_drop_perc;
};
