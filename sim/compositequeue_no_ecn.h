...
class CompositeQueueNoEcn : public Queue {
  public:
    ...
    void set_random_drop_percentage(double value) { random_drop_percentage = value; }
    ...
    double random_drop_percentage;
    double _num_random_drops;
    static std::mt19937 _random_drop_gen;
    static std::uniform_real_distribution<double> random_drop_dist;
    int _num_packets;
